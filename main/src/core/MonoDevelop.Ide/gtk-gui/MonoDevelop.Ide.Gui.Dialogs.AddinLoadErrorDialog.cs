...
namespace MonoDevelop.Ide.Gui.Dialogs
{
	internal partial class AddinLoadErrorDialog
	{
		...
		protected virtual void Build ()
		{
			...
			this.labelContinue.LabelProp = global::Mono.Unix.Catalog.GetString ("You can start MonoDevelop without these add-ins, but the functionality they provi" +
					"de will be missing. Do you wish to continue?");
			...
			this.labelWarning.LabelProp = global::Mono.Unix.Catalog.GetString ("MonoDevelop can run without these add-ins, but the functionality they provide wil" +
					"l be missing.");
