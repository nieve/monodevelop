...
namespace MonoDevelop.Stereo.Refactoring.MoveToAnotherFile
{
	public class MoveToAnotherFileRefactoring : RefactoringOperation, IRefactorTask
	{
		...
		public override List<Change> PerformChanges (RefactoringOptions options, object properties)
		{
			...
			var body = type.GetDefinition().BodyRegion;
			var content = editor.GetTextBetween(body.BeginLine, 1, body.EndLine, body.EndColumn);
			...
			int num = editor.Document.LocationToOffset(body.BeginLine, 1);
